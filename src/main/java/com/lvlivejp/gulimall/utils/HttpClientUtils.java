...
public class HttpClientUtils {
    ...
    private static final int SOCKET_TIMEOUT = 60000000;
     ...
     * @throws Exception
     */
    public static HttpClientResult doPostJson(String url, Map<String, String> headers, String jsonString, CookieStore cookieStore) throws Exception {
        // 创建httpClient对象
        CloseableHttpClient httpClient;
        if(cookieStore == null){
            httpClient = HttpClients.createDefault();
